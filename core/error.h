...
#define THROW_ERROR(...) throw std::runtime_error(format_error(__FILE__,__LINE__,__FUNCTION__, 0,     __VA_ARGS__))
#define THROW_ERRNO(...) throw std::runtime_error(format_error(__FILE__,__LINE__,__FUNCTION__, errno, __VA_ARGS__))
